    ...
    if (this.options.showExport) {
      ...
      if (!$export.length) {
        ...
        $menu.find("li").click(function () {
            ...
            doExport = function () {
              if (!!that.options.exportFooter) {
                ...
                $.each($footerRow.children(), function (index, footerCell) {
                  var footerCellHtml = $(footerCell)
                    .children(".th-inner")
                    .first()
                    .html();
                  footerData[that.columns[index].field] =
                    footerCellHtml == "&nbsp;" ? null : footerCellHtml;
                ...
                $.each(
                  $lastTableRow.children(),
                  function (index, lastTableRowCell) {
          ...
          if (
            that.options.exportDataType === "all" &&

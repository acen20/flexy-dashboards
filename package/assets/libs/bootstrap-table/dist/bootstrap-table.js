...
(function ($) {
  ...
  BootstrapTable.prototype.initToolbar = function () {
    ...
    if (this.options.showFullscreen) {
      this.$toolbar
        ...
        .off("click")
        .on("click", $.proxy(this.toggleFullscreen, this));
    }
    ...
    if (!this.options.onlyInfoPagination) {
      ...
      if (typeof this.options.pageList === "string") {
        ...
        $.each(list, function (i, value) {
          pageList.push(
            value.toUpperCase() ===
              that.options.formatAllRows().toUpperCase() ||
    ...
    this.$body
      ...
      .on("click dblclick", function (e) {
        ...
        if (
          ...
          that.options.ignoreClickToSelectOn(e.target)
        ) {
  ...
  BootstrapTable.prototype.refreshColumnTitle = function (params) {
    ...
    if (this.columns[this.fieldsColumnsIndex[params.field]].visible) {
      var header =
        this.options.height !== undefined ? this.$tableHeader : this.$header;
